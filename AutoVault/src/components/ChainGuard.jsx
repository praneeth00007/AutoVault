            ...
            >
                <div className="max-w-md w-full mx-6">
                    ...
                    >
                        ...
                        <h2 className="text-2xl font-black text-white mb-4 tracking-tight">Wallet Connection Required</h2>
                        <p className="text-slate-400 mb-10 leading-relaxed text-sm">
                            AutoVault requires a connected wallet to access the secure workspace and perform confidential computations on <span className="text-white font-bold">Arbitrum Sepolia Testnet</span>.
                        </p>
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                <span className="text-[10px] font-black uppercase tracking-[0.2em]">Connect Wallet</span>
